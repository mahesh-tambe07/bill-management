...
Label(text="BILL MANAGEMENT",bg="Black",fg="White", width="300",height="2", font=("times new roman",34)).pack()
...
Label(f, font=("Lucida Calligraphy", 15, 'bold'), text="Samosa...Rs.15/plate", fg="black", bg="lightgreen").place(x=10,y=110)
Label(f, font=("Lucida Calligraphy", 15, 'bold'), text="Tea.. .Rs.7/plate", fg="black", bg="lightgreen").place(x=10,y=140)
Label(f, font=("Lucida Calligraphy", 15, 'bold'), text="Cofee...Rs.100/plate", fg="black", bg="lightgreen").place(x=10,y=170)
...
Label(f, font=("Lucida Calligraphy", 15, 'bold'), text="Kachori... Rs.15/plate", fg="black", bg="lightgreen").place(x=10,y=260)
...
entry_kachori=Entry (f1, font=("aria", 20, 'bold'), textvariable=kachori, bd=6, width=8,bg="lightpink")
...
entry_kachori.grid(row=7,column=1)
